...
import 'package:homeless/mediLab/utils/codePicker/selection_dialog.dart';
      ...
      _widget = TextButton(
        ...
        child: Flex(
          ...
          children: <Widget>[
            ...
            Flexible(
              fit: widget.alignLeft ? FlexFit.tight : FlexFit.loose,
              child: text(selectedItem!.toCountryCodeString(), textColor: Colors.black, fontSize: 16.0),
            ),
          ],
        ),
      );
