            ...
            child: SingleChildScrollView(
              child: Column(
                ...
                children: <Widget>[
                  ...
                  24.height,
                  Row(
                    children: [Text(mlHave_no_code!, style: primaryTextStyle()), 8.width, Text('Re-send', style: boldTextStyle(color: mlColorDarkBlue, decoration: TextDecoration.underline)), const Text('01:58', textAlign: TextAlign.right).expand()],
                  ),
                  24.height,
                  SizedBox(
                    height: buttonHeight,
